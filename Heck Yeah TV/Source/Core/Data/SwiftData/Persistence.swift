...
final class Persistence {
    ...
    private init() {
        do {
            guard var _rootURL = FileManager.default.urls(for: FileManager.SearchPathDirectory.applicationSupportDirectory,
            ...
            // Exclude from backups.  At this time I would prefer to let the store rebuild itself.  Users would lose channels indicated as favorites, recently played channels, etc...
